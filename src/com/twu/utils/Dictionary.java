...
public class Dictionary {
    ...
    public static final String MESSAGE_SUCCESSFUL_BOOK_CHECK_OUT = "Thank you! Enjoy the book";
    public static final String MESSAGE_UNSUCCESSFUL_BOOK_CHECK_OUT ="That book is not available";
